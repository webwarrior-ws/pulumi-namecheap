...
namespace Pulumi.Namecheap
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Namecheap.version.txt");
    ...
    internal sealed class NamecheapResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NamecheapResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
