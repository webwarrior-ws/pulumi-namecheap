...
import (
	...
	namecheap "github.com/namecheap/terraform-provider-namecheap/namecheap" // Import the upstream provider
...
const (
	...
	mainPkg = "namecheap"
	// modules:
	mainMod = "index" // the namecheap module
)

//go:embed cmd/pulumi-resource-namecheap/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-namecheap/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-namecheap/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "namecheap", namecheap.Provider(),
		...
		// convention is to have a function at "github.com/namecheap/terraform-provider-namecheap/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(namecheap.Provider()),
		...
		Keywords:   []string{"namecheap", "category/cloud"},
		License:    "Apache-2.0",
		...
		Config: map[string]*tfbridge.SchemaInfo{
			...
			"region": {
				Type: "namecheap:region/region:Region",
			},
		},
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/webwarrior-ws/pulumi-namecheap/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("namecheap_", mainMod,
